...
public class HamburgerBrett2 {
    private final BlockingQueue<Hamburger2> brett;
    private final AtomicInteger antall;
    ...
    public synchronized void addBurger2(String navn) throws InterruptedException {
        ...
        Hamburger2 burger = new Hamburger2(inkrement);
        brett.put(burger);
        System.out.print("\nKokk " +navn+ " la på burger nr " + burger.getBurger() + " nå er det " + brett.size() + " burgere på brettet");
    }

    public synchronized Hamburger2 removeBurger2(String navn) throws InterruptedException {

        Hamburger2 hamburger = brett.take();
